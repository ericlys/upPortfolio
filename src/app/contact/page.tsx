  ...
  return (
    <div>
      ...
      <div className="container mx-auto mb-10 mt-14 p-4">
        ...
        <div className="mt-12 flex flex-row items-center justify-center gap-16 rounded-3xl bg-slate-300 p-6">
          <div>
            <p className="flex  max-w-2xl flex-1 text-justify text-sm font-medium text-gray-600">
            ...
            <div className="mt-8 flex flex-wrap gap-4">
              <Link
                ...
                className="flex justify-center gap-2 rounded bg-blue-700 p-2 font-bold text-white hover:scale-105"
              >
              ...
              <Link
                ...
                className="flex items-center justify-center gap-2 rounded bg-green-700 p-2 font-bold text-white hover:scale-105"
              >
              ...
              <Link
                ...
                className="flex items-center justify-center gap-2 rounded bg-purple-700 p-2 font-bold text-white hover:scale-105"
              >
              ...
              <Link
                ...
                target="_blank"
                download
                className="flex items-center justify-center gap-2 rounded bg-red-700 p-2 font-bold text-white hover:scale-105"
              >
